# 🧪 Test Case: SIASIS-TC-35 - Validar que el Directivo obtenga los datos de todos los Personal Administrativos registrados del Sistema

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-35
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-35                                                                 |
> | **Nombre**          | Validar que el Directivo obtenga los datos de todos los Personales Administrativos registrados del Sistema  |
...
>
> ```gherkin
> @Ver-Todos-Personal-Admin-Directivo
> ```
...
>
> Este test evalúa el método GET, que obtiene los datos de todos los Personales Administrativos a través de la API del sistema y mediante el login exitoso del Directivo.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET obtenga los datos de todos los Personales Administrativos mediante la sesion exitosa del Directivo
>
> **Criterio de Éxito:** <br>
> Código de estado: 200 OK <br>
> Campo message : "Personal administrativo obtenido exitosamente" <br>
> Campo success: **true**
...
>
> ```gherkin
> Feature: Obtener los datos de todos los Personales Administrativos registrados en el Sistema
>  Como Directivo 
>  Quiero poder obtener los datos de todos los Personales Administrativos registrados
...
>   Scenario: Obtener los datos de todos los Personals Administrativos Registrados
...
>   And La respuesta debe tener el response : message :"Personal Administrativo obtenido exitosamente"
> ```
