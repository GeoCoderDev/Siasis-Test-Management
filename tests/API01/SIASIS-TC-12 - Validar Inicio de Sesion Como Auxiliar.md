# 🧪 Test Case: SIASIS-TC-12 - Validar Inicio de Sesión de Sesión Exitoso para rol de Auxiliar

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-12
...
> | **Nombre**          | Validar Inicio de Sesión de Sesión Exitoso <br> para rol de Auxiliar |
...
>
> Este test evalúa el flujo de autenticación exitoso para el rol de Auxiliar mediante la validación del inicio de sesión a través de la API del sistema.
...
>
> ```gherkin
> Feature: Inicio de Sesion de Auxiliar
>  Como Auxiliar
