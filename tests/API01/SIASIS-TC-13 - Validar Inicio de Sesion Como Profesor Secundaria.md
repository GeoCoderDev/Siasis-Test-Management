# 🧪 Test Case: SIASIS-TC-13 - Validar Inicio de Sesión de Sesión Exitoso para rol de Profesor de Secundaria (No tutor)

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-13
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-13                                                                    |
> | **Nombre**          | Validar Inicio de Sesión de Sesión Exitoso <br> para rol de Profesor de Secundaria(No tutor) |
...
>
> Este test evalúa el flujo de autenticación exitoso para el rol de Profesor de Secundaria (No tutor) mediante la validación del inicio de sesión a través de la API del sistema.
