...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-26                                                                  |
> | **Nombre**          | Validar la obtención de datos del rol Auxiliar |
...
>
> Este test evalúa el método GET que obtiene todos los datos del rol Auxiliar a través de la API del sistema.
...
>
> ```gherkin
> Feature: Obtener Datos del Rol Auxiliar
>  Como Auxiliar
>  Quiero obtener los datos asociados al rol Auxiliar
...
>   Scenario: Obtener todos los datos del rol Auxiliar
