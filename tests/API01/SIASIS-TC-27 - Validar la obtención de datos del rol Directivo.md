# 🧪 Test Case: SIASIS-TC-27 - Validar la obtención de datos del rol Directivo

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-27
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-27                                                                 |
> | **Nombre**          | Validar la obtención de datos del rol Directivo |
...
>
> Este test evalúa el método GET que obtiene todos los datos del rol Directivo a través de la API del sistema.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET para obtener los datos del rol Directivo funcione correctamente y devuelva la información precisa y completa del rol.
>
...
>
> ```gherkin
> Feature: Obtener Datos del Rol Directivo
>  Como Directivo
...
>   Scenario: Obtener todos los datos del rol Directivo
