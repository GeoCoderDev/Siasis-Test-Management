# 🧪 Test Case: SIASIS-TC-28 - Validar la obtención de datos del rol Tutor de Secundaria

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-28
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-28                                                                 |
> | **Nombre**          | Validar la obtención de datos del rol Tutor Secundaria |
...
>
> ```gherkin
> @Obtener-Mis-Datos-Tutor-Secundaria
> ```
...
>
> Este test evalúa el método GET que obtiene todos los datos del rol Tutor Secundaria a través de la API del sistema.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET para obtener los datos del rol Tutor Secundaria funcione correctamente y devuelva la información precisa y completa del rol.
>
...
>
> ```gherkin
> Feature: Obtener Datos del Rol Tutor de Secundaria
>  Como Tutor de  Secundaria
>  Quiero obtener los datos asociados al rol 
...
>   Scenario: Obtener todos los datos del rol Tutor de Secundaria
...
>
> - 📊 **Datos específicos:** Credenciales **_(Nombre de Usuario y Contraseña)_** de un usuario con Rol de Tutor de Secundaria
