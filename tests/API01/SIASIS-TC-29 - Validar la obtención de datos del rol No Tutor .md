...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-29                                                                 |
> | **Nombre**          | Validar la obtención de datos del rol No Tutor |
...
>
> Este test evalúa el método GET que obtiene todos los datos del rol No Tutor a través de la API del sistema.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET para obtener los datos del rol No Tutor Secundaria funcione correctamente y devuelva la información precisa y completa del rol.
>
...
>
> ```gherkin
> Feature: Obtener Datos del Rol No Tutor
>  Como No Tutor
...
>   Scenario: Obtener todos los datos del rol No Tutor
