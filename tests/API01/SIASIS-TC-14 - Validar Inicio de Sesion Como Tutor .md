# 🧪 Test Case: SIASIS-TC-14 - Validar Inicio de Sesión de Sesión Exitoso para rol de Tutor

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-14
...
>
> Este test evalúa el flujo de autenticación exitoso para el rol de Tutor mediante la validación del inicio de sesión a través de la API del sistema.
