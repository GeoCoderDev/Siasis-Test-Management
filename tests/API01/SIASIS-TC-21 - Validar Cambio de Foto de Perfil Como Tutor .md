# 🧪 Test Case: SIASIS-TC-21 - Validar Cambio de Foto de Perfil Exitoso para el Rol de Tutor

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-21
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-21                                                                  |
> | **Nombre**          | Validar Cambio de foto de Perfil  Exitoso para rol de Tutor |
...
>
> ```gherkin
> @Modificar-Foto-Perfil-Tutor-Secundaria
> ```
...
>
> Este test evalúa el flujo de cambio de foto de perfil exitoso para el rol de Tutor a través de la API del sistema.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que los usuarios con el rol de Tutor puedan cambiar su foto de perfil exitosamente
>
...
>   Scenario: Cambiar Foto de Perfil para el rol de Tutor
