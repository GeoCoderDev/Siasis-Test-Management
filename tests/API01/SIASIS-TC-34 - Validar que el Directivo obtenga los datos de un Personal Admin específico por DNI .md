# 🧪 Test Case: SIASIS-TC-34 - Validar que el Directivo obtenga los datos de un Personal Admin específico por DNI

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-34
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-34                                                                 |
> | **Nombre**          | Validar que el Directivo obtenga los datos de un Personal Admin específico por DNI  |
...
>
> ```gherkin
> @Obtener-Datos-Personal-Admin-Especifico
> ```
...
>
> Este test evalúa el método GET, que obtiene los datos del  rol de Personal Admin través de la API del sistema y  mediante el login exitoso del Directivo.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET obtenga los datos del rol Personal Admin mediante la sesion exitosa del Directivo.
>
...
>
> ```gherkin
> Feature: Obtener los datos de un Personal Admin especifico por DNI 
>  Como Directivo 
>  Quiero poder obtener los datos de un auxiliar especifico
>   Para poder validar la informacion correspondiente
>
>   Background:
...
>   Scenario: Obtener los datos de un Personal Admin especifico por DNI
