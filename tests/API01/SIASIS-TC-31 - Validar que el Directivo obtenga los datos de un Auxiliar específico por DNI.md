# 🧪 Test Case: SIASIS-TC-31 - Validar que el Directivo obtenga los datos de un Auxiliar específico por DNI
...
> | **Nombre**          | Validar que el Directivo obtenga los datos de un Auxiliar específico por DNI  |
...
>
> ```gherkin
> @Obtener-Datos-Auxiliar-Especifico
> ```
...
> Campo message : "Auxiliar obtenido exitosamente" <br>
> Campo success: **true**
...
>
> ```gherkin
> Feature: Obtener los datos de un Auxiliar especifico por DNI 
>  Como Directivo 
...
>   Scenario: Obtener los datos de un Auxiliar especifico por DNI
...
>   And La respuesta debe tener el response : message :"Auxiliar obtenido exitosamente"
> ```
