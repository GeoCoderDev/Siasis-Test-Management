# 🧪 Test Case: SIASIS-TC-25 - Validar la obtención de datos del rol Personal Admin
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-25                                                                  |
> | **Nombre**          | Validar la obtención de datos del rol Personal Admin |
...
>
> ```gherkin
> @Obtener-Mis-Datos-Personal-Admin
> ```
...
>
> Este test evalúa el método GET que obtiene todos los datos del rol Personal Admin a través de la API del sistema.
...
>
> ```gherkin
> Feature: Obtener Datos del Rol Personal Admin
>  Como Personal Admin
>  Quiero obtener los datos asociados al rol Personal Admin
...
>   Scenario: Obtener todos los datos del rol Personal Admin
