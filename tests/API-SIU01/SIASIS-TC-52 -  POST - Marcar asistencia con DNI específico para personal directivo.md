# 🧪 Test Case: SIASIS-TC-52 - Validar el metodo POST para marcar Asistencia con DNI para el el rol de Directivo

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-52
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-52                                                                   |
> | **Nombre**          | Validar el metodo POST para marcar Asistencia con DNI para el el rol de Directivo|
...
>
> Este test valida que el servidor responda correctamente a una solicitud POST para marcar la asistencia del rol de Directivo.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método POST funcione correctamente para marcar la asistencia de un personal como Directivo.
>
...
>
>   @SIASIS-TC-52 @API-SIU01 @AsistenciaHoy-DNI-Directivo
