# 🧪 Test Case: SIASIS-TC-62 - Validar el metodo GET para obtener mi propia asistencia

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-62
...
> | Campo               |                                    Valor                                    |
> | --------------------- | :----------------------------------------------------------------------------: |
> | **ID Test Case**    |                                 SIASIS-TC-62                               |
> | **Nombre**          | Validar el metodo GET para obtener mi propia asistencia |
...
>
> ```gherkin
> @AsistenciaHoy-ObtenerMiAsistencia         
> ```
...
>
> Este test valida que el servidor responda correctamente a una solicitud GET para  obtener la propia Asistencia de cada rol

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método GET obtenga la asistencia propia de cada rol
>
...
>
> ```gherkin
>    @SIASIS-TC-62 @API-SIU01 @AsistenciaHoy-ObtenerMiAsistencia                
