# 🧪 Test Case: SIASIS-TC-53 - Validar el metodo POST para marcar Asistencia con DNI para el el rol de Auxiliar

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-53
...
>
> Este test valida que el servidor responda correctamente a una solicitud POST para marcar la asistencia del rol de Auxiliar.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método POST funcione correctamente para marcar la asistencia de un personal como Auxiliar.
>
...
>
>   @SIASIS-TC-53 @API-SIU01 @AsistenciaHoy-DNI-Auxiliar
>   Scenario: Marcar asistencia con DNI específico para personal Auxiliar
