# 🧪 Test Case: SIASIS-TC-56 - Validar el metodo POST para marcar Asistencia con DNI para el el rol de Profesor Secundaria - Tutor

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-56
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-56                                                                   |
> | **Nombre**          | Validar el metodo POST para marcar Asistencia con DNI para el el rol de Profesor Secundaria - Tutor|
...
>
> ```gherkin
> @AsistenciaHoy-DNI-ProfesorSecundariaTutor
> ```
...
>
> Este test valida que el servidor responda correctamente a una solicitud POST para marcar la asistencia del rol de Profesor Secundaria - Tutor

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método POST funcione correctamente para marcar la asistencia de un personal como Profesor Secundaria - Tutor.
>
...
>
>   @SIASIS-TC-56 @API-SIU01 @AsistenciaHoy-DNI-ProfesorSecundariaTutor
>   Scenario: Marcar asistencia con DNI específico para Profesor Secundaria - Tutor
