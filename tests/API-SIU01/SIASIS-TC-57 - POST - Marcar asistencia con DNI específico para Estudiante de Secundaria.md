# 🧪 Test Case: SIASIS-TC-57 - Validar el metodo POST para marcar Asistencia con DNI para estudiantes de Secundaria con el rol  de Auxiliar

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-57
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-57                                                                  |
> | **Nombre**          | Validar el metodo POST para marcar Asistencia con DNI para estudiantes de Secundaria con el rol de Auxiliar|
...
>
> ```gherkin
> @AsistenciaHoy-DNI-EstudiantesSecundaria
> ```
...
>
> Este test valida que el servidor responda correctamente a una solicitud POST para marcar la asistencia de los estudiantes de secundaria con el rol de Auxiliar.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método POST funcione correctamente para marcar la asistencia de los estudiantes de Secundaria con el rol de Auxiliar
>
...
>
>   @SIASIS-TC-57 @API-SIU01 @AsistenciaHoy-DNI-EstudiantesSecundaria
>   Scenario: Marcar asistencia con DNI específico a los estudiantes de Secundaria
>   Given El usuario tiene credenciales válidas para tomar Asistencia como Auxiliar
