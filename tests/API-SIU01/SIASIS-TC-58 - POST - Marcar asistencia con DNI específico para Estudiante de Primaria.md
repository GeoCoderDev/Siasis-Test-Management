# 🧪 Test Case: SIASIS-TC-58 - Validar el metodo POST para marcar Asistencia con DNI para estudiantes de Primaria con el rol de Profesor de Primaria

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-58
...
> | Campo                     |                                                                        Valor                                                                        |
> | ------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                    SIASIS-TC-58                                                                   |
> | **Nombre**          | Validar el metodo POST para marcar Asistencia con DNI para estudiantes de Primaria con el rol de Profesor de Primaria|
...
>
> ```gherkin
> @AsistenciaHoy-DNI-EstudiantesPrimaria
> ```
...
>
> Este test valida que el servidor responda correctamente a una solicitud POST para marcar la asistencia de los estudiantes de Primaria con el rol de Profesor de Primaria.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Verificar que el método POST funcione correctamente para marcar la asistencia de los estudiantes de Primaria con el rol de Profesor de Primaria
>
...
>
> ```gherkin
> Feature: Marcar Asistencia como Auxiliar
>  Como QA
...
>
>   @SIASIS-TC-58 @API-SIU01 @AsistenciaHoy-DNI-EstudiantesPrimaria
>   Scenario: Marcar asistencia con DNI específico a los estudiantes de Primaria
>   Given El usuario tiene credenciales válidas para tomar Asistencia como Profesor de Primaria
