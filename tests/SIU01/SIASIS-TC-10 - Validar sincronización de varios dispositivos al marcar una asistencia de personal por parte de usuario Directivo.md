# 🧪 Test Case: SIASIS-TC-10 - Validar sincronización de varios dispositivos al marcar una asistencia de personal por parte de usuario Directivo

> [!IMPORTANT]
> **ID del Test Case:** SIASIS-TC-10
...
> | Campo                     |                                                          Valor                                                          |
> | ------------------------- | :---------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                      SIASIS-TC-10                                                      |
> | **Nombre**          | Validar sincronización de varios dispositivos al marcar una<br />asistencia de personal por parte de usuario Directivo |
...
>
> Este es un test para verificar que la funcionalidad de marcado de asistencia de personal de manera sincronizada en varios dipositivos funciona.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Validar que un usuario o usuarios con rol Directivo pueden marcar la asistencia del Personal en varios dispositivos de manera sincronizada.
>
> **Criterio de Éxito:** Las asistencias marcadas en un dispositivo se marcan en el resto de dispositivos tambien.
...
>     Given he seleccionado en todos los dispositivos el mismo tipo de registro(Entrada o Salida) para el mismo Rol
>     When marco la asistencia de cualquier personal en uno de los dispositivos
>     Then la asistencia se marca en todos los dispositivos a la vez
> ```
...
> - 🔗 **Relacionado:** SIASIS-TC-11 (Caso negativo para marcado de toma de asistencia en varios dispositivos)
...
**📅 Última Actualización:** 28/06/2025 01:00AM
