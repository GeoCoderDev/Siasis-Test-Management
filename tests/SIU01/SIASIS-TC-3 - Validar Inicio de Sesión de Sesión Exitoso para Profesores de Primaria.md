...
> | Campo                     |                                                                                  Valor                                                                                  |
> | ------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                               SIASIS-TC-3                                                                               |
> | **Nombre**          |                                                      Validar Inicio de Sesión Exitoso para Profesores de Primaria                                                      |
...
>
> ```gherkin
> @SIASIS-TC-3 @happy @login @auth @regresion @smoke
> ```
>
> **Tags por componente:**
>
...
>
> ```gherkin
> @profesor-primaria @personal-colegio @todos-los-roles
> ```
...
>
> Este es un **test de autenticación específico** que verifica el flujo de login exitoso para el rol de Auxiliar en el sistema SIASIS.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Validar que un usuario con rol Profesor de Primaria puede iniciar sesión correctamente con sus credenciales y acceder a su interfaz de bienvenida correspondiente.
>
...
**📅 Última Actualización:** 28/06/2025 07:05PM
