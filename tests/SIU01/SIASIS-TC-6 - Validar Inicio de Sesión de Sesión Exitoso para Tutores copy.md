...
>
> ```gherkin
> @SIASIS-TC-6 @happy @login @auth @regresion @smoke
> ```
>
> **Tags por componente:**
>
...
>
> ```gherkin
> @tutor @personal-colegio @todos-los-roles
> ```
...
>
> Este es un **test de autenticación específico** que verifica el flujo de login exitoso para el rol de Tutor en el sistema SIASIS.

> [!NOTE]
>
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Validar que un usuario con rol Tutor puede iniciar sesión correctamente con sus credenciales y acceder a su interfaz de bienvenida correspondiente.
>
...
**📅 Última Actualización:** 28/06/2025 07:20PM
