...
> | Campo                     |                                                                                  Valor                                                                                  |
> | ------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
> | **ID Test Case**    |                                                                               SIASIS-TC-4                                                                               |
> | **Nombre**          |                                                            Validar Inicio de Sesión Exitoso para Auxiliares                                                            |
...
>
> ```gherkin
> @SIASIS-TC-4 @happy @login @auth @regresion @smoke
> ```
>
> **Tags por componente:**
>
...
>
> ```gherkin
> @auxiliar @personal-colegio @todos-los-roles
> ```
...
> ### 🎯 Objetivo Principal
>
> **Objetivo:** Validar que un usuario con rol Profesor de Auxiliar puede iniciar sesión correctamente con sus credenciales y acceder a su interfaz de bienvenida correspondiente.
>
...
**📅 Última Actualización:** 28/06/2025 07:10PM
